    ...
    <div class="language-selector">
        ...
        <div class="language-dropdown">
            <div class="language-selected">
                ...
                <span id="current-language" class="user-name">Español</span>
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="language-options">
                <div class="language-option" data-value="es">
                    <img src="/BANCO_CAMBA/assets/img/spanish.png" alt="Español" class="flag-icon">
                    <span>Español</span>
                </div>
    ...
    <div class="user-profile">
        ...
        <div class="user-dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="#" class="dropdown-item">
                    <img src="/BANCO_CAMBA/assets/img/config.png" alt="Configuración" class="menu-icon"> Configuración
                </a>
                <div class="dropdown-divider"></div>
                <a href="index.php?controller=usuario&action=cerrarSesion" class="logout-btn">
                    <img src="/BANCO_CAMBA/assets/img/cerrar.png" alt="Cerrar Sesión" class="menu-icon"> <?php echo $lang['logout']; ?>
                </a>
            </div>
        </div>
    </div>
