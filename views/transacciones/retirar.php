...
<head>
    ...
    <title>Retiro de Fondos - Banco Mercantil</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .btn-warning:hover {
            ...
            transform: translateY(-2px);
            box-shadow: 0 4px 8px rgba(229, 193, 41, 0.3);
        }
...
<body>
    ...
    <div class="page-header">
        <h2><i class="fas fa-money-bill-wave"></i> Retiro de Fondos</h2>
    </div>
        ...
        <div class="form-section">
            ...
            <form method="POST" action="index.php?controller=transaccion&action=procesarRetiro" class="needs-validation" novalidate id="withdrawForm">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control" rows="3"><?php echo isset($lang['withdrawal']) ? $lang['withdrawal'] : 'Retiro de efectivo'; ?></textarea>
                </div>
    ...
    <div class="help-cards">
        <div class="help-card" onclick="showHelp('account')">
            ...
            <div class="help-card-title">¿Dónde encontrar mi número de cuenta?</div>
            <div class="help-card-text">Su número aparece en la libreta, tarjeta de débito o app móvil</div>
        </div>
        
        <div class="help-card" onclick="showHelp('balance')">
            <div class="help-card-icon"><i class="fas fa-coins"></i></div>
            <div class="help-card-title">Verificar saldo disponible</div>
            <div class="help-card-text">Asegúrese de tener fondos suficientes antes de retirar</div>
        </div>
        
        <div class="help-card" onclick="showHelp('authorization')">
            <div class="help-card-icon"><i class="fas fa-user-check"></i></div>
            <div class="help-card-title">Autorización de cuentas</div>
            <div class="help-card-text">Solo puede retirar de cuentas donde es titular o tiene autorización</div>
        </div>
        
        <div class="help-card" onclick="showHelp('limits')">
            <div class="help-card-icon"><i class="fas fa-chart-line"></i></div>
            <div class="help-card-title">Límites de retiro</div>
            <div class="help-card-text">El monto máximo depende del tipo de cuenta y saldo disponible</div>
        </div>
    </div>
